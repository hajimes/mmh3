...
- `src/mmh3`
  - `mmh3module.c`: the main file that serves as the interface between Python and the MurmurHash3 c implementation.
  - `murmurhash.c`: implentations of the MurmurHash3 family. Auto-generated from Austin Appleby's original code. DO NOT edit this file manually. See [README in the util directory](../util/README.md) for details.
  - `murmurhash.h`: headers and macros for MurmurHash3. Auto-gerated from `util/refresh.py`. DO NOT edit this file manually.
...
When you changed the source in a way which may cause endian issues, you may want
